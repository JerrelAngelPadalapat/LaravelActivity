...
<div class="left-side-menu">
    ...
    <div class="sidebar-icon-menu">
        ...
        <div class="logo-box">
            <!-- Brand Logo Light -->
            <a href="index.php">
                <img src="{{ asset('template/images/logo-sm.png') }}" alt="small logo" height="28">
            </a>
        </div>
    ...
    <div class="app-menu">
        ...
        <div class="logo-box">
            ...
            <a href="index.php" class="logo-light">
                <img src="{{ asset('template/images/logo-light-2.png') }}" alt="logo" class="logo-lg">
                <img src="{{ asset('template/images/logo-sm.png') }}" alt="small logo" class="logo-sm">
            </a>

            <!-- Brand Logo Dark -->
            <a href="index.php" class="logo-dark">
                <img src="{{ asset('template/images/logo-dark-2.png') }}" alt="dark logo" class="logo-lg">
                <img src="{{ asset('template/images/logo-sm.png') }}" alt="small logo" class="logo-sm">
            </a>
        </div>
